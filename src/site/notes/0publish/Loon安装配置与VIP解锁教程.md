...
1. 在闲鱼搜索 **"iOS 降级"**、**"App 降级"** 或 **"Loon 降级"**
...
> - 降级前建议先 **备份当前配置**（Loon 支持导出配置文件）

### 降级后的注意事项

- 降级完成后，建议参考本文档 **第十步** 关闭自动更新，防止再次自动升级

![_resources/Pasted image 20260709115011.png](/img/user/_resources/Pasted%20image%2020260709115011.png)